...
public class HomeActivity extends AppCompatActivity {
    ...
    public void ClickFazerPedido(View view){
        redirectActivity(this,FazerPedidoActivity.class);
    }

    public void ClickMeusPedidos(View view){
        redirectActivity(this,MeusPedidosActivity.class);
    }

    public void ClickRastreamento(View view){ redirectActivity(this,RastreioActivity.class); }
